...
- **Адаптивна сітка стовпчиків:**  
  ...
  вписується в екран без обрізання. Сітка стовпчиків центрується по
  горизонталі відносно ширини вікна.
- Зручне меню управління у терміналі:
  - Навігація стрілками ↑↓←→ — **циклічна**: вихід за межі стовпчика чи
    ...
    зліва↔справа). Малювання екрана виконано через прямі ANSI-послідовності
    (без зайвих викликів зовнішніх процесів), тож навігація не гальмує навіть
    при частих натисканнях клавіш.
